...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<title>Kết quả xổ số kiến thiết miền bắc</title>
	</head>
	<body>
		<div id="wrapper">
			<div id="content">
				...
				<div class="actions">
					...
					<div>
						<h4>Best number today by the data from 2003 to 2017.</h4>
						<button id="get_best_number_bf_2017" class="btn btn-primary">Find the best numbers</button>
						<div class="loading">
							<img src="images/loading1.gif" />
						</div>
					...
					<div>
						...
						<button id="get_best_number_by_sp_ys" class="btn btn-primary">Find the best numbers</button>
						<div class="loading">
							<img src="images/loading1.gif" />
						</div>
